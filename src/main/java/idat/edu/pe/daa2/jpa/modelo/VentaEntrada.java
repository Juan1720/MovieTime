...
@NamedQueries({
	...
	@NamedQuery(name="VentaEntrada.findByAsientos",query="SELECT v FROM VentaEntrada v WHERE v.asientos=:asientos"),
...
public class VentaEntrada implements Serializable{
	...
	@JoinColumn(name = "precio", referencedColumnName = "idPrecio")
	@ManyToOne(optional = false)
    ...
    public VentaEntrada(Integer idEntrada, Float cantEntradas, Date fecha,String asientos,Float montoTotal) {
    	this.idEntrada=idEntrada;
